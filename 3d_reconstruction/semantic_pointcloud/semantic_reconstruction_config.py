...
class ReconstructionConfig:
    ...
    # custom_model_path: str = "models/dynamic_object/best_model2.pth"
    custom_model_path: str = "models/dynamic_object/best_model.pth"
    ...
    # ============================================================================
    downsample_y: int = 3 #6 #9  # Vertical downsampling factor
    downsample_x: int = 2 #4 #6  # Horizontal downsampling factor
